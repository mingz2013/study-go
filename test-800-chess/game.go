...
import (
	"study-go/test-800-chess/centergame"
	"study-go/test-800-chess/ipc"
	"fmt"
	"strconv"
	"strings"
	"bufio"
...
var centerClient *centergame.CenterClient

func startCenterService() error {
	server := ipc.NewIpcServer(&centergame.CenterServer{})
	client := ipc.NewIpcClient(server)
	centerClient = &centergame.CenterClient{client}
	return nil
}
